    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%", background: "#0A0A12", borderRight: "1px solid rgba(255,255,255,0.06)" }}>
      <div style={{ padding: "20px", display: "flex", alignItems: "center", gap: "12px", borderBottom: "1px solid rgba(255,255,255,0.06)", flexShrink: 0 }}>
        ...
        <div>
          ...
          <p style={{ fontSize: "11px", color: "rgba(255,255,255,0.4)", margin: 0 }}>Admin Panel</p>
        </div>
      </div>
    ...
    <div style={{ display: "flex", height: "100vh", overflow: "hidden", background: "#050508" }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0, overflow: "hidden" }}>
        <div style={{ padding: "12px 16px", borderBottom: "1px solid rgba(255,255,255,0.06)", background: "#0A0A12", display: "flex", alignItems: "center", gap: "10px", flexShrink: 0 }}>
          ...
          <span style={{ fontSize: "13px", color: "rgba(255,255,255,0.5)", fontWeight: 600 }}>Admin Panel</span>
        </div>
